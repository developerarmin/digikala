...
fun BasketItem() {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(
                horizontal = MaterialTheme.spacing.large, vertical = MaterialTheme.spacing.large
            )
    ) {
        IconButton(onClick = { }) {
            Icon(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.superMarketArticle),
    ...
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(
                top = MaterialTheme.spacing.extraLarge + MaterialTheme.spacing.medium +
                        MaterialTheme.spacing.extraSmall,
                end = MaterialTheme.spacing.superLarge +
        ...
        modifier = Modifier
            ...
            .padding(
                top = MaterialTheme.spacing.extraLarge +
                        MaterialTheme.spacing.large + MaterialTheme.spacing.medium
            ),
